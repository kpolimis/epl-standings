...
- Four trajectory clusters derived from k-means: permanent fixtures, yo-yo regulars, modern era entrants, departed regulars
...
├── epl-positions.md             # Blog post (Sports)
├── epl-clustering-tutorial.md   # Technical companion post (Tutorials)
├── data/
